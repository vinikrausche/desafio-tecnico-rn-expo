...
export default function ProductsCatalogScreen() {
  ...
  function confirmDeleteProduct(
    ...
    showConfirm({
      ...
      onConfirm: () => {
        void handleDeleteProduct(productId, productName, storeId);
      },
  ...
  return (
    ...
    >
      <VStack style={styles.content}>
        <ListHeader
          badgeLabel={`${catalogProducts.length} produtos`}
          title="Lista"
        />
        ...
        {hasCatalogError ? (
          <StateCard
            ...
            message={
              catalogErrorMessage ?? 'Nao foi possivel carregar os produtos.'
            }
            onAction={() =>
              void Promise.all([
